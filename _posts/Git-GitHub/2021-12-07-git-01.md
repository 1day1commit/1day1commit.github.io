...
last_modified_at: 2021-12-07T16:47:21+0900
---
...
여기서 `Comment`에 체크하고 **Submit review** 버튼을 누르면 다른 기능 없이 댓글만 남기는 것입니다.

`Approve`에 체크했을 경우 merge 하는 것에 동의한다는 의미입니다. merge를 하기 위해서는 정해진 개수 이상의 Approve를 받아야 합니다.

`Request changes`는 꼭 수정을 해달라는 의미로 Approve 개수가 채워진 상태라도 Request changes 가 하나라도 있으면 mrege 할 수 없습니다.